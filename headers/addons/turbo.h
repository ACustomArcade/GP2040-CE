...
private:
    ...
    uint16_t p1LastPressed;       // Last buttons pressed (for Turbo Enable)
    uint16_t p1LastDpad;          // Last d-pad pressed (for Turbo Change)
    uint16_t p2LastPressed;       // Last buttons pressed (for Turbo Enable)
    uint16_t p2LastDpad;          // Last d-pad pressed (for Turbo Change)
