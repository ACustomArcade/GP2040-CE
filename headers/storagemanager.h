...
struct BoardOptions
{
	...
	uint8_t pinP1DpadRight;
	uint8_t pinP1ButtonB1;
	uint8_t pinP1ButtonB2;
	uint8_t pinP1ButtonB3;
	uint8_t pinP1ButtonB4;
	uint8_t pinP1ButtonL1;
	uint8_t pinP1ButtonR1;
	uint8_t pinP1ButtonL2;
	uint8_t pinP1ButtonR2;
	uint8_t pinP1ButtonS1;
	uint8_t pinP1ButtonS2;
	uint8_t pinP1ButtonL3;
	...
	uint8_t pinP2DpadRight;
	uint8_t pinP2ButtonB1;
	uint8_t pinP2ButtonB2;
	uint8_t pinP2ButtonB3;
	uint8_t pinP2ButtonB4;
	uint8_t pinP2ButtonL1;
	uint8_t pinP2ButtonR1;
	uint8_t pinP2ButtonL2;
	uint8_t pinP2ButtonR2;
	uint8_t pinP2ButtonS1;
	uint8_t pinP2ButtonS2;
	uint8_t pinP2ButtonL3;
	uint8_t pinP2ButtonR3;
	uint8_t pinP2ButtonA1;
	uint8_t pinP2ButtonA2;
