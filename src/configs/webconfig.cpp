...
void addUsedPinsArray(DynamicJsonDocument& doc)
{
	...
	addPinIfValid(boardOptions.pinP1DpadUp);
	addPinIfValid(boardOptions.pinP1DpadDown);
	addPinIfValid(boardOptions.pinP1DpadLeft);
	addPinIfValid(boardOptions.pinP1DpadRight);
	addPinIfValid(boardOptions.pinP1ButtonB1);
	addPinIfValid(boardOptions.pinP1ButtonB2);
	addPinIfValid(boardOptions.pinP1ButtonB3);
	addPinIfValid(boardOptions.pinP1ButtonB4);
	addPinIfValid(boardOptions.pinP1ButtonL1);
	addPinIfValid(boardOptions.pinP1ButtonR1);
	addPinIfValid(boardOptions.pinP1ButtonL2);
	addPinIfValid(boardOptions.pinP1ButtonR2);
	addPinIfValid(boardOptions.pinP1ButtonS1);
	addPinIfValid(boardOptions.pinP1ButtonS2);
	addPinIfValid(boardOptions.pinP1ButtonL3);
	addPinIfValid(boardOptions.pinP1ButtonR3);
	addPinIfValid(boardOptions.pinP1ButtonA1);
	addPinIfValid(boardOptions.pinP1ButtonA2);
	addPinIfValid(boardOptions.pinP2DpadUp);
	addPinIfValid(boardOptions.pinP2DpadDown);
	addPinIfValid(boardOptions.pinP2DpadLeft);
	addPinIfValid(boardOptions.pinP2DpadRight);
	addPinIfValid(boardOptions.pinP2ButtonB1);
	addPinIfValid(boardOptions.pinP2ButtonB2);
	addPinIfValid(boardOptions.pinP2ButtonB3);
	addPinIfValid(boardOptions.pinP2ButtonB4);
	addPinIfValid(boardOptions.pinP2ButtonL1);
	addPinIfValid(boardOptions.pinP2ButtonR1);
	addPinIfValid(boardOptions.pinP2ButtonL2);
	addPinIfValid(boardOptions.pinP2ButtonR2);
	addPinIfValid(boardOptions.pinP2ButtonS1);
	addPinIfValid(boardOptions.pinP2ButtonS2);
	addPinIfValid(boardOptions.pinP2ButtonL3);
	addPinIfValid(boardOptions.pinP2ButtonR3);
	addPinIfValid(boardOptions.pinP2ButtonA1);
	addPinIfValid(boardOptions.pinP2ButtonA2);
...
std::string setPinMappings()
{
	...
	boardOptions.pinP1DpadUp    = convertPin("P1 Up");
	boardOptions.pinP1DpadDown  = convertPin("P1 Down");
	boardOptions.pinP1DpadLeft  = convertPin("P1 Left");
	boardOptions.pinP1DpadRight = convertPin("P1 Right");
	boardOptions.pinP1ButtonB1  = convertPin("P1 B1");
	boardOptions.pinP1ButtonB2  = convertPin("P1 B2");
	boardOptions.pinP1ButtonB3  = convertPin("P1 B3");
	boardOptions.pinP1ButtonB4  = convertPin("P1 B4");
	boardOptions.pinP1ButtonL1  = convertPin("P1 L1");
	boardOptions.pinP1ButtonR1  = convertPin("P1 R1");
	boardOptions.pinP1ButtonL2  = convertPin("P1 L2");
	boardOptions.pinP1ButtonR2  = convertPin("P1 R2");
	boardOptions.pinP1ButtonS1  = convertPin("P1 S1");
	boardOptions.pinP1ButtonS2  = convertPin("P1 S2");
	boardOptions.pinP1ButtonL3  = convertPin("P1 L3");
	boardOptions.pinP1ButtonR3  = convertPin("P1 R3");
	boardOptions.pinP1ButtonA1  = convertPin("P1 A1");
	boardOptions.pinP1ButtonA2  = convertPin("P1 A2");
	boardOptions.pinP2DpadUp    = convertPin("P2 Up");
	boardOptions.pinP2DpadDown  = convertPin("P2 Down");
	boardOptions.pinP2DpadLeft  = convertPin("P2 Left");
	boardOptions.pinP2DpadRight = convertPin("P2 Right");
	boardOptions.pinP2ButtonB1  = convertPin("P2 B1");
	boardOptions.pinP2ButtonB2  = convertPin("P2 B2");
	boardOptions.pinP2ButtonB3  = convertPin("P2 B3");
	boardOptions.pinP2ButtonB4  = convertPin("P2 B4");
	boardOptions.pinP2ButtonL1  = convertPin("P2 L1");
	boardOptions.pinP2ButtonR1  = convertPin("P2 R1");
	boardOptions.pinP2ButtonL2  = convertPin("P2 L2");
	boardOptions.pinP2ButtonR2  = convertPin("P2 R2");
	boardOptions.pinP2ButtonS1  = convertPin("P2 S1");
	boardOptions.pinP2ButtonS2  = convertPin("P2 S2");
	boardOptions.pinP2ButtonL3  = convertPin("P2 L3");
	boardOptions.pinP2ButtonR3  = convertPin("P2 R3");
	boardOptions.pinP2ButtonA1  = convertPin("P2 A1");
	boardOptions.pinP2ButtonA2  = convertPin("P2 A2");
...
std::string getPinMappings()
{
	...
	const BoardOptions& boardOptions = Storage::getInstance().getBoardOptions();
	writeDoc(doc, "P1Up", convertPin(boardOptions.pinP1DpadUp));
	writeDoc(doc, "P1 Down", convertPin(boardOptions.pinP1DpadDown));
	writeDoc(doc, "P1 Left", convertPin(boardOptions.pinP1DpadLeft));
	writeDoc(doc, "P1 Right", convertPin(boardOptions.pinP1DpadRight));
	writeDoc(doc, "P1 B1", convertPin(boardOptions.pinP1ButtonB1));
	writeDoc(doc, "P1 B2", convertPin(boardOptions.pinP1ButtonB2));
	writeDoc(doc, "P1 B3", convertPin(boardOptions.pinP1ButtonB3));
	writeDoc(doc, "P1 B4", convertPin(boardOptions.pinP1ButtonB4));
	writeDoc(doc, "P1 L1", convertPin(boardOptions.pinP1ButtonL1));
	writeDoc(doc, "P1 R1", convertPin(boardOptions.pinP1ButtonR1));
	writeDoc(doc, "P1 L2", convertPin(boardOptions.pinP1ButtonL2));
	writeDoc(doc, "P1 R2", convertPin(boardOptions.pinP1ButtonR2));
	writeDoc(doc, "P1 S1", convertPin(boardOptions.pinP1ButtonS1));
	writeDoc(doc, "P1 S2", convertPin(boardOptions.pinP1ButtonS2));
	writeDoc(doc, "P1 L3", convertPin(boardOptions.pinP1ButtonL3));
	writeDoc(doc, "P1 R3", convertPin(boardOptions.pinP1ButtonR3));
	writeDoc(doc, "P1 A1", convertPin(boardOptions.pinP1ButtonA1));
	writeDoc(doc, "P1 A2", convertPin(boardOptions.pinP1ButtonA2));
	writeDoc(doc, "P2 Up", convertPin(boardOptions.pinP2DpadUp));
	writeDoc(doc, "P2 Down", convertPin(boardOptions.pinP2DpadDown));
	writeDoc(doc, "P2 Left", convertPin(boardOptions.pinP2DpadLeft));
	writeDoc(doc, "P2 Right", convertPin(boardOptions.pinP2DpadRight));
	writeDoc(doc, "P2 B1", convertPin(boardOptions.pinP2ButtonB1));
	writeDoc(doc, "P2 B2", convertPin(boardOptions.pinP2ButtonB2));
	writeDoc(doc, "P2 B3", convertPin(boardOptions.pinP2ButtonB3));
	writeDoc(doc, "P2 B4", convertPin(boardOptions.pinP2ButtonB4));
	writeDoc(doc, "P2 L1", convertPin(boardOptions.pinP2ButtonL1));
	writeDoc(doc, "P2 R1", convertPin(boardOptions.pinP2ButtonR1));
	writeDoc(doc, "P2 L2", convertPin(boardOptions.pinP2ButtonL2));
	writeDoc(doc, "P2 R2", convertPin(boardOptions.pinP2ButtonR2));
	writeDoc(doc, "P2 S1", convertPin(boardOptions.pinP2ButtonS1));
	writeDoc(doc, "P2 S2", convertPin(boardOptions.pinP2ButtonS2));
	writeDoc(doc, "P2 L3", convertPin(boardOptions.pinP2ButtonL3));
	writeDoc(doc, "P2 R3", convertPin(boardOptions.pinP2ButtonR3));
	writeDoc(doc, "P2 A1", convertPin(boardOptions.pinP2ButtonA1));
	writeDoc(doc, "P2 A2", convertPin(boardOptions.pinP2ButtonA2));
...
std::string setKeyMappings()
{
	...
	readDoc(gamepad->options.keyP1DpadUp, doc, "P1 Up");
	readDoc(gamepad->options.keyP1DpadDown, doc, "P1 Down");
	readDoc(gamepad->options.keyP1DpadLeft, doc, "P1 Left");
	readDoc(gamepad->options.keyP1DpadRight, doc, "P1 Right");
	readDoc(gamepad->options.keyP1ButtonB1, doc, "P1 B1");
	readDoc(gamepad->options.keyP1ButtonB2, doc, "P1 B2");
	readDoc(gamepad->options.keyP1ButtonB3, doc, "P1 B3");
	readDoc(gamepad->options.keyP1ButtonB4, doc, "P1 B4");
	readDoc(gamepad->options.keyP1ButtonL1, doc, "P1 L1");
	readDoc(gamepad->options.keyP1ButtonR1, doc, "P1 R1");
	readDoc(gamepad->options.keyP1ButtonL2, doc, "P1 L2");
	readDoc(gamepad->options.keyP1ButtonR2, doc, "P1 R2");
	readDoc(gamepad->options.keyP1ButtonS1, doc, "P1 S1");
	readDoc(gamepad->options.keyP1ButtonS2, doc, "P1 S2");
	readDoc(gamepad->options.keyP1ButtonL3, doc, "P1 L3");
	readDoc(gamepad->options.keyP1ButtonR3, doc, "P1 R3");
	readDoc(gamepad->options.keyP1ButtonA1, doc, "P1 A1");
	readDoc(gamepad->options.keyP1ButtonA2, doc, "P1 A2");

	readDoc(gamepad->options.keyP2DpadUp, doc, "P2 Up");
	readDoc(gamepad->options.keyP2DpadDown, doc, "P2 Down");
	readDoc(gamepad->options.keyP2DpadLeft, doc, "P2 Left");
	readDoc(gamepad->options.keyP2DpadRight, doc, "P2 Right");
	readDoc(gamepad->options.keyP2ButtonB1, doc, "P2 B1");
	readDoc(gamepad->options.keyP2ButtonB2, doc, "P2 B2");
	readDoc(gamepad->options.keyP2ButtonB3, doc, "P2 B3");
	readDoc(gamepad->options.keyP2ButtonB4, doc, "P2 B4");
	readDoc(gamepad->options.keyP2ButtonL1, doc, "P2 L1");
	readDoc(gamepad->options.keyP2ButtonR1, doc, "P2 R1");
	readDoc(gamepad->options.keyP2ButtonL2, doc, "P2 L2");
	readDoc(gamepad->options.keyP2ButtonR2, doc, "P2 R2");
	readDoc(gamepad->options.keyP2ButtonS1, doc, "P2 S1");
	readDoc(gamepad->options.keyP2ButtonS2, doc, "P2 S2");
	readDoc(gamepad->options.keyP2ButtonL3, doc, "P2 L3");
	readDoc(gamepad->options.keyP2ButtonR3, doc, "P2 R3");
	readDoc(gamepad->options.keyP2ButtonA1, doc, "P2 A1");
	readDoc(gamepad->options.keyP2ButtonA2, doc, "P2 A2");
...
std::string getKeyMappings()
{
	...
	writeDoc(doc, "P1 Up", gamepad->options.keyP1DpadUp);
	writeDoc(doc, "P1 Down", gamepad->options.keyP1DpadDown);
	writeDoc(doc, "P1 Left", gamepad->options.keyP1DpadLeft);
	writeDoc(doc, "P1 Right", gamepad->options.keyP1DpadRight);
	writeDoc(doc, "P1 B1", gamepad->options.keyP1ButtonB1);
	writeDoc(doc, "P1 B2", gamepad->options.keyP1ButtonB2);
	writeDoc(doc, "P1 B3", gamepad->options.keyP1ButtonB3);
	writeDoc(doc, "P1 B4", gamepad->options.keyP1ButtonB4);
	writeDoc(doc, "P1 L1", gamepad->options.keyP1ButtonL1);
	writeDoc(doc, "P1 R1", gamepad->options.keyP1ButtonR1);
	writeDoc(doc, "P1 L2", gamepad->options.keyP1ButtonL2);
	writeDoc(doc, "P1 R2", gamepad->options.keyP1ButtonR2);
	writeDoc(doc, "P1 S1", gamepad->options.keyP1ButtonS1);
	writeDoc(doc, "P1 S2", gamepad->options.keyP1ButtonS2);
	writeDoc(doc, "P1 L3", gamepad->options.keyP1ButtonL3);
	writeDoc(doc, "P1 R3", gamepad->options.keyP1ButtonR3);
	writeDoc(doc, "P1 A1", gamepad->options.keyP1ButtonA1);
	writeDoc(doc, "P1 A2", gamepad->options.keyP1ButtonA2);

	writeDoc(doc, "P2 Up", gamepad->options.keyP2DpadUp);
	writeDoc(doc, "P2 Down", gamepad->options.keyP2DpadDown);
	writeDoc(doc, "P2 Left", gamepad->options.keyP2DpadLeft);
	writeDoc(doc, "P2 Right", gamepad->options.keyP2DpadRight);
	writeDoc(doc, "P2 B1", gamepad->options.keyP2ButtonB1);
	writeDoc(doc, "P2 B2", gamepad->options.keyP2ButtonB2);
	writeDoc(doc, "P2 B3", gamepad->options.keyP2ButtonB3);
	writeDoc(doc, "P2 B4", gamepad->options.keyP2ButtonB4);
	writeDoc(doc, "P2 L1", gamepad->options.keyP2ButtonL1);
	writeDoc(doc, "P2 R1", gamepad->options.keyP2ButtonR1);
	writeDoc(doc, "P2 L2", gamepad->options.keyP2ButtonL2);
	writeDoc(doc, "P2 R2", gamepad->options.keyP2ButtonR2);
	writeDoc(doc, "P2 S1", gamepad->options.keyP2ButtonS1);
	writeDoc(doc, "P2 S2", gamepad->options.keyP2ButtonS2);
	writeDoc(doc, "P2 L3", gamepad->options.keyP2ButtonL3);
	writeDoc(doc, "P2 R3", gamepad->options.keyP2ButtonR3);
	writeDoc(doc, "P2 A1", gamepad->options.keyP2ButtonA1);
	writeDoc(doc, "P2 A2", gamepad->options.keyP2ButtonA2);
